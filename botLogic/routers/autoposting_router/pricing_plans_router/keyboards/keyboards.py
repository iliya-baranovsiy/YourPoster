...
def get_pricing_plans_menu_kb(auto_pay: bool, payment_plan: str) -> InlineKeyboardMarkup:
...
def get_agree_or_not_pay_kb() -> InlineKeyboardMarkup:
    buttons = [
        [
...
def back_to_menu_or_pay() -> InlineKeyboardMarkup:
    buttons = [
...
def question_auto_pay_kb() -> InlineKeyboardMarkup:
    buttons = [
        [
...
def extend_or_back_kb() -> InlineKeyboardMarkup:
    buttons = [
        [
