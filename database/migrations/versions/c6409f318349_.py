...
Revision ID: c6409f318349
Revises:
Create Date: 2026-04-26 21:23:55.414842
...
def upgrade() -> None:
    ...
    op.create_index(
        "channels_index", "Channels", ["channel_id", "owner_id"], unique=False
    )
    op.create_table(
        "User_payments",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "payment_plan",
            sa.Enum("STANDART", "PRO", "VIP", name="paymentoptions"),
            server_default=sa.text("'STANDART'"),
            nullable=False,
        ),
...
def downgrade() -> None:
    ...
    op.execute("DROP TYPE IF EXISTS paymentoptions")
    # ### end Alembic commands ###
